...
public class Message {
	...
	public Message( int size, String _fileName, String _Title, String _Desc,
                        String _Tags, String _Time_stamp, String _Conference_stamp,
                        String Function) {
		this.size = size;
	...
	public String toString() {
		...
		sb.append(", ");
		sb.append("Conference_stamp:" + getConference_stamp());
		sb.append(",");
